...
public class Main {
  ...
  public static boolean find(Node root, int tar) {
      ...
      if(tar < root.data) return find(root.left, tar);
      else if(tar > root.data) return find(root.right, tar);
      else return true;
  }
   
  // finding for n nodes, so TC = NlogN 
  public static void findPairsEqualsToTarget(Node oroot, Node root, int target) {
      if(root == null) return;
      
      findPairsEqualsToTarget(oroot, root.left, target);
      ...
      findPairsEqualsToTarget(oroot, root.right, target);
  }
  //========================================================================================
  ...
  public static void main(String[] args) throws Exception {
    ...
    findPairsEqualsToTarget(root, root, target);
